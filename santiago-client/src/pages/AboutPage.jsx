      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 overflow-hidden">
            <img
              src="/src/assets/windframe-about.png"
              alt="About Windframe"
          ...
          <div>
            ...
            <h1 className="max-w-xl text-3xl font-bold leading-tight text-zinc-900 sm:text-4xl">
              About Windframe: Engineering Meets Innovation
            </h1>
            <p className="mt-4 max-w-lg text-sm leading-7 text-zinc-600 sm:text-base">
              Windframe is a hybrid construction and technology firm dedicated to building smarter, greener, and more connected infrastructure. We merge engineering excellence with digital innovation to deliver sustainable solutions for the future.
            </p>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="mt-6 space-y-4">
              <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-600">
                  Windframe was founded with a vision to merge construction expertise with cutting-edge technology, creating infrastructure that adapts to modern needs.
                </p>
              </article>
          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5 text-center">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2 text-4xl">
              <div className="flex items-center justify-center rounded-[1.25rem] bg-zinc-200">🏗️</div>
              <div className="flex items-center justify-center rounded-[1.25rem] bg-zinc-200">🌱</div>
              <div className="flex items-center justify-center rounded-[1.25rem] bg-zinc-200">💻</div>
              <div className="flex items-center justify-center rounded-[1.25rem] bg-zinc-200">🔮</div>
            </div>
